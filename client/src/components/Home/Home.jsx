            ...
            <main className="main-content">
                    ...
                    <button className="submit-button">
                        <span>
                            <svg width="24" height="21" viewBox="0 0 24 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M0 10.5H21.5M21.5 10.5L13 2M21.5 10.5L13 19" stroke="black" stroke-width="3" />
                            </svg>
                        </span>
                    </button>
                </div>
                <div className="Templates3">
                    ...
                    <div className="temp">
                        ...
                        <Template
                            title="Landing Page"
                            svg={<svg width="43" height="37" viewBox="0 0 43 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M21.5 0L42.7176 36.75H0.282377L21.5 0Z" fill="#D9D9D9" />
                            </svg>}
                        />
                        <Template
                            title="E-commerce"
